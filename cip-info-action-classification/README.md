...
| ID | Type | Description |
| --- | --- | --- |
| NCL | Net Change Limit | As described within constitution |
| HFN | Hard Fork Naming | voting for the name of the next hard fork |
